...
class Scenario(BaseScenario):
    def make_world(self, args=None):
        ...
        for i, agent in enumerate(world.agents):
            ...
            if agent.adversary:
                ...
                agent.size = 0.05
                agent.accel = 4
                agent.max_speed = 1.25
            print("----agent i :", i , "--size : ", agent.size, "--accel : ", agent.accel, "--max speed : ", agent.max_speed)
    ...
    def prey_policy(self, agent, world):
        ...
        chosen_action = np.clip(np.random.randn(2), -1, 1) * 0.5
        # pdb.set_trace()
    ...
    def observation(self, agent, world):
        ...
        for entity in world.landmarks:
            ...
            if not entity.boundary and (agent.view_radius >= 0) and dist <= agent.view_radius:
                ...
                entity_pos.append(np.array([3., 3.]))
