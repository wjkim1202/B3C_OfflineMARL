...
class OMIGA(object):
    def __init__(self, observation_spec, action_spec, state_spec,  num_agent, eval_env, config):
        ...
        self._mix_network = MixNet(state_spec, action_spec, num_agent, self._mix_hidden_sizes, self._device).to(self._device)
    ...
    def train_step(self, o, s, a, r, mask, s_next, o_next, a_next, pg_norm=1, clipq=False, max_return=1e5):
